        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="card-title text-center fs-24 lh-35 pb-4">Hesabına Giriş Yap!</h3>
                        <div class="section-block"></div>
                        <form  class="pt-4" method="POST" action="{{ route('admin.login') }}">
                            @csrf
                            ...
                            <div class="input-box">
                                <label class="label-text">E-mail Adresiniz</label>
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="email" placeholder="Email Adresiniz">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                <label class="label-text">Şifreniz</label>
                                <div class="input-group mb-3">
                                    <span class="la la-lock input-icon"></span>
                                    <input class="form-control form--control password-field" type="password" name="password" placeholder="Şifreniz">
                            ...
                            <div class="btn-box">
                                <div class="d-flex align-items-center justify-content-between pb-4">
                                    ...
                                    <a href="recover.html" class="btn-text">Şifreni mi Unuttun?</a>
                                </div>
                                <button class="btn theme-btn" type="submit">Giriş Yap <i class="la la-arrow-right icon ml-1"></i></button>
                                <p class="fs-14 pt-2">Hesabın Yok mu? <a href="sign-up.html" class="text-color hover-underline">Kayıt Ol</a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
