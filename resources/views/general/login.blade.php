...
<head>
    ...
    <title>YKAKKAYA Online Danışmanlık</title>
</head>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    ...
                                    <div class="text-center mb-4">
                                        <h5 class="">Dashboard Giriş Ekranı</h5>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="col-md-6 text-end"> <a
                                                    href="{{ route('password.request') }}">Şifreni mi Unuttun ?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
                                            ...
                                            <div class="col-12">
                                                <div class="text-center ">
                                                    <p class="mb-0">Henüz Bir Hesabın Yok mu? <a
                                                            href="{{ route('register') }}">Hesap Oluştur</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </form>
