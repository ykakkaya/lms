            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    @empty(Auth::user()->image)
                        <img src="{{ asset('admin/no_image.jpg') }}" class="user-img" alt="user avatar">
                    @else
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('admin.profile.show') }}"><i
                                class="bx bx-user fs-5"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="{{ route('admin.profile.changePassword') }}"><i
                                class="bx bx-cog fs-5"></i><span>Şifre Değiştir</span></a>
                    </li>
